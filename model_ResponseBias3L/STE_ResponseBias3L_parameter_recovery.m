...
prc_param_names = {'om2', 'om3', 'al'};
prc_param_idx   = [13, 14, 15];
prc_param_space = {'native', 'native', 'log'};
obs_param_names = {'zeta0', 'zeta1', 'beta0', 'beta1', 'beta2', 'beta3', 'beta4', 'beta5', 'sa'};
obs_param_idx   = [1, 2, 3, 4, 5, 6, 7, 8, 9];
obs_param_space = {'log', 'native', 'native', 'native', 'native', 'native', 'native', 'native', 'log'};
...
save('ResponseBias3L_recovery.mat', 'recov');
