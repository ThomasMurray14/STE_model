function [prc_config, obs_config] = STE_ResponseBias3L_config

prc_config = prc_ResponseBias3L_ehgf_binary_pu_tbt_config(); % perceptual model
obs_config = obs_ResponseBias3L_comb_obs_config(); % response model
