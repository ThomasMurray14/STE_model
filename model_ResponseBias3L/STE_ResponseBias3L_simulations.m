%% MODEL 3
% Perceptual model 
%   = [prc1] 3 level eHGF Nace remix (fixed rho=0)
% Response model 
...
[prc_config, obs_config] = STE_ResponseBias3L_config;
...
prc_params = prc_ResponseBias3L_ehgf_binary_pu_tbt_transp(r_temp, prc_config.priormus);

obs_params = obs_config.priormus;
obs_params(1) = exp(obs_params(1));
obs_params(9) = exp(obs_params(9));
...
visualise_psychometric(u, sub_data, 'prc_ResponseBias3L_ehgf_binary_pu_tbt', prc_params, 'obs_ResponseBias3L_comb_obs', obs_params, 20)


%% Plot trajectory
prc_ResponseBias3L_ehgf_binary_tbt_plotTraj(sim_3_bias);
