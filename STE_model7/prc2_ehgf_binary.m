function [traj, infStates] = prc2_ehgf_binary(r, p, varargin)
% Calculates the trajectories of the agent's representations under the HGF
% 
% 
% EDITED BY TOM TO IGNORE SECOND COLUMN OF U
% 
% 
%
...
% Assume that if u has more than one column, the last contains t - TOM EDIT
t = ones(n,1);
% try
