function [pvec, pstruct] = obs1_logrt_linear_binary_transp(r, ptrans)
...
pvec(1)     = ptrans(1);         % be0
pstruct.beta0 = pvec(1);

pvec(2)     = ptrans(2);         % be1
pstruct.beta1 = pvec(2);

pvec(3)     = ptrans(3);         % be2
pstruct.beta2 = pvec(3);

pvec(4)     = ptrans(4);         % be3
pstruct.beta3 = pvec(4);

pvec(5)     = ptrans(5);         % be4
pstruct.beta4 = pvec(5);
