...
% Perceptual = binary HGF (2 level)
% response = psychometric (prediction of PSE) using precision-weighted
% surprise
...
[om2_sim, om2_est, b0_sim, b0_est, b1_sim, b1_est, zeta_sim, zeta_est] = deal(nan(N,1));
...
save('STE_model7b0fixed_recovery.mat', 'om2_sim', 'om2_est', 'b0_sim', 'b0_est', 'b1_sim', 'b1_est', 'zeta_sim', 'zeta_est');
