%% MODEL 1
% Perceptual model 
%   = [prc1] 3 level eHGF Nace remix (bias on prediction)
% Response model 
...
[prc_config, obs_config] = STE_PredictionBias3L_config;
...
prc_params = prc_PredictionBias3L_ehgf_binary_pu_tbt_transp(r_temp, prc_config.priormus);
...
visualise_psychometric(u, sub_data, 'prc_PredictionBias3L_ehgf_binary_pu_tbt', prc_params, 'obs_PredictionBias3L_comb_obs', obs_params, 20)
N_sad = sum(sim_sad);

%% Plot trajectory
prc_PredictionBias3L_ehgf_binary_tbt_plotTraj(sim);
