function c = prc_PerceptualBias3L_ehgf_binary_pu_tbt_config
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
% Model name
c.model = 'prc_PerceptualBias3L_ehgf_binary_pu_tbt';
...
c.prc_fun = @prc_PerceptualBias3L_ehgf_binary_pu_tbt;

% Handle to function that transforms perceptual parameters to their native space
% from the space they are estimated in
c.transp_prc_fun = @prc_PerceptualBias3L_ehgf_binary_pu_tbt_transp;
