...
figure; hold on;
plot(1:5, LMEs_valid, 'color', [0 0.4470 0.7410, .2], 'linewidth', .1)
plot(1:5, mean(LMEs_valid, 1), '-o', 'color', 'black', 'linewidth', 2, 'MarkerFaceColor', [1,1,1])
