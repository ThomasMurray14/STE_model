...
% obs_params = obs_RW_logrt_linear_binary_transp([], obs_config.priormus);
% 
% sim = tapas_simModel(u, ...
%     'prc_RW_binary', ...
%     prc_params,...
%     'obs_RW_logrt_linear_binary', ...
%     obs_params);
% 
...
%     optim_config);
% 
% %%% Seems to work... Let's try combined....
...
prc_params = bopars.p_prc.p;
obs_params = obs_RW_comb_obs_transp([], obs_config.priormus);
